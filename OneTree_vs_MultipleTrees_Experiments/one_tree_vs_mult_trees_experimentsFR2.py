...
algos = {'One Tree FR2': [one_tree_pre, RouteOneTree],'Multiple Trees FR2': [multiple_trees_pre,RouteMultipleTrees]}
...
def experiments(switch="all", seed=0, rep=100):
    if switch in ["regular", "all"]:
        out = start_file("results/benchmark-regular-FR2-1TvsMT-" + str(n) + "-" + str(k))
