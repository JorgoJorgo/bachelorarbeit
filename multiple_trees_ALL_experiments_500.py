...
'One Tree Breite Mod FR10': [one_tree_pre,RouteOneTree],
'MultipleTrees Mod Breite FR10': [multiple_trees_pre_breite_mod, RouteMultipleTrees],
'MultipleTrees Mod Anzahl FR10': [multiple_trees_pre_num_of_trees_mod, RouteMultipleTrees],
'MultipleTrees Mod Reihenfolge FR10': [multiple_trees_pre_order_of_edps_mod, RouteMultipleTrees],
'MultipleTrees Mod Parallel FR10': [multiple_trees_pre_parallel, RouteMultipleTrees],
'One Tree Breite Mod FR10': [one_tree_pre_breite_mod,RouteOneTree]
}
...
def experiments(switch="all", seed=0, rep=100):
    ...
    if switch in ["zoo", "all"]:
        out = start_file("results/benchmark-zoo-all-multiple-trees-TIME-FR10" + str(k))
