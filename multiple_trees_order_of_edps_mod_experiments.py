...
algos = {'MultipleTrees Tree': [multiple_trees_pre_order_of_edps_mod, RouteMultipleTrees]}
...
def experiments(switch="all", seed=0, rep=100):
    ...
    if switch in ["AS"]:
        out = start_file("results/benchmark-as_seed-order-of-edps-multtrees-" + str(seed))
