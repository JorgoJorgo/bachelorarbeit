...
algos = {'One Tree FR9': [one_tree_pre, RouteOneTree],'One Tree Breite Mod FR9': [one_tree_pre_breite_mod,RouteOneTree]}
...
def experiments(switch="all", seed=0, rep=100):
    if switch in ["regular", "all"]:
        out = start_file("results/benchmark-regular-FR9-1tVS1tM-" + str(n) + "-" + str(k))
...
if __name__ == "__main__":
    ...
    seed = 0  #random seed
    name = "benchmark-FR9-1tVS1tM-" #result files start with this name
