...
algos = {'One Tree FR6': [one_tree_pre, RouteOneTree],'Multiple Trees FR6': [multiple_trees_pre,RouteMultipleTrees]}
...
def experiments(switch="all", seed=0, rep=100):
    if switch in ["regular", "all"]:
        out = start_file("results/benchmark-regular-FR6-" + str(n) + "-" + str(k))
