...
#Hier erfolgt die Ausführung von MultipleTrees mit modifizierter Anzahl
algos = {'MultipleTrees Num Mod': [multiple_trees_pre_num_of_trees_mod, RouteMultipleTrees]}
