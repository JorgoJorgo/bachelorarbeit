...
if (plotfig):
    ...
    #plt.subplot(222)
    # plt.plot(X, parallel_mit_infs_Resilienz[2:11], color='y', label='Parallel', linewidth=0.7)
    # plt.plot(X, invert_mit_infs_Resilienz[2:11], color='m', label='Invers', linewidth=0.7)
    # plt.plot(X, random_mit_infs_Resilienz[2:11], color='b', label='Randomisiert', linewidth=0.7)
